...
writer = SummaryWriter(log_dir="runs100000/ppo_ibuprofen")
...
class PPOAgent:
    def __init__(self, state_dim, action_dim, lr, gamma, eps_clip, batch_size, ppo_epochs, entropy_beta, buffer_size,
        ...
        self.writer = SummaryWriter(log_dir="runs100000/ppo_ibuprofen")
...
def objective(trial):
    ...
    for episode in range(100000):  # Number of episodes per trial
...
try:
    for episode in range(100000):  # Number of training episodes
